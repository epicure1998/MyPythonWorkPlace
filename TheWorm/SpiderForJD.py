...
def parsePage():
    ...
    for index, singleEntry in enumerate(entry):
        ...
        name = singleEntry.find_element_by_class_name('p-name').find_element_by_tag_name('a').find_element_by_tag_name(
            'em').text
        price = singleEntry.find_element_by_class_name('p-price').find_element_by_tag_name(
            'strong').find_element_by_tag_name('i').text
        comment = singleEntry.find_element_by_class_name('p-commit').find_element_by_tag_name(
            'strong').find_element_by_tag_name('a').text
        jsonfile = {"name": name,
                    "price": price,
                    "link": link,
                    "comment": comment
